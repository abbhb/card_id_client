search_uri = "G:/pycode/card_id_signin/examples/search.html"
sidebar_uri = "/G:/pycode/card_id_signin/examples/sidebar.html"
# 相对路径假如运行用的python example/find_face_qt_v2.py就用的根目录的数据库 直接进example里python find_face_qt_v2.py就是这个目录，所以写死
db_uri = "G:/pycode/card_id_signin/examples/face_data.db"
card_mode = 16 # 打卡器输出模式：16为16进制输出，10为十进制输出
server_port = 25401
secert = "sbgh34y234"
my_ip = "10.15.246.66"
card_com = 'COM4'
